...
<html lang="es">
            ...
            <div class="row" style="margin-top:35px;">
                <div class="col-lg-12">
                    ...
                    <div class="row"> 
                        <div class="btn-group col-lg-12">
                            <div class="col-lg-8 offset-lg-2">
                                <input type="text" id="txtbuscar" class="form form-control" placeholder="Buscar movimientos">
                            </div>
                            <div class="col-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12" id="tablamovi">
                        ...
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-lg-8">
                                    <input type="text" id="txtagregar" class="form form-control" placeholder="Añadir nuevo movimiento" maxlength="100">
                                </div>
                                <div class="col-lg-4">
    ...
    <script src="../../js/scripts/movimientos/catalogo_de_movimientos.js"></script>
</html>